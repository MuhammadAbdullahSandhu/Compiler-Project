...
#### Flags Description
## -L :
Prints the entire list of tokens generated by the lexer.

## -A :
Parses the code using the parser to validate the syntax.

## -AST :
Prints the Abstract Syntax Tree (AST) for the program.

## -ST :
Displays the Symbol Table.

## -TAC :
Prints the Three-Address Code (TAC) generated for the program.

## -O :
Purpose: Prints the optimized Three-Address Code (TAC).

## -ASM :
Purpose: Prints the assembly code generated for the program.
